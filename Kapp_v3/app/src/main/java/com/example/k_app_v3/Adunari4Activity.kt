...
class Adunari4Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_adunari4)

        // Legaturi cu elementele din layout
        val tvOperation: TextView = findViewById(R.id.add4Text)
        val etAnswer: EditText = findViewById(R.id.ans4Add)
        val btnCheck: Button = findViewById(R.id.verif4BtnAdd)
        val tvResult: TextView = findViewById(R.id.rez4Add)
        val tvScore: TextView = findViewById(R.id.scor4Add)
    ...
    private fun generateNewOperation(
        ...
        val num1 = (0..500000).random()
        val num2 = (0..100000).random()
