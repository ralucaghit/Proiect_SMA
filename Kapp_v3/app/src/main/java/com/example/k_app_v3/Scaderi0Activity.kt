...
class Scaderi0Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_scaderi0)

        // Legaturi cu elementele din layout
        val tvOperation: TextView = findViewById(R.id.sub0Text)
        val etAnswer: EditText = findViewById(R.id.ans0Sub)
        val btnCheck: Button = findViewById(R.id.verif0BtnSub)
        val tvResult: TextView = findViewById(R.id.rez0Sub)
        val tvScore: TextView = findViewById(R.id.scor0Sub)
