...
class Scaderi4Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_scaderi4)

        // Legaturi cu elementele din layout
        val tvOperation: TextView = findViewById(R.id.sub4Text)
        val etAnswer: EditText = findViewById(R.id.ans4Sub)
        val btnCheck: Button = findViewById(R.id.verif4BtnSub)
        val tvResult: TextView = findViewById(R.id.rez4Sub)
        val tvScore: TextView = findViewById(R.id.scor4Sub)
    ...
    private fun generateNewOperation(
        ...
        val num1 = (0..1000000).random()
        val num2 = (0..800000).random()
