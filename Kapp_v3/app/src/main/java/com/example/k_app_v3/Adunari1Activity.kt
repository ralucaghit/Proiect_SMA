...
class Adunari1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_adunari1)

        // Legaturi cu elementele din layout
        val tvOperation: TextView = findViewById(R.id.add1Text)
        val etAnswer: EditText = findViewById(R.id.ans1Add)
        val btnCheck: Button = findViewById(R.id.verif1BtnAdd)
        val tvResult: TextView = findViewById(R.id.rez1Add)
        val tvScore: TextView = findViewById(R.id.scor1Add)
