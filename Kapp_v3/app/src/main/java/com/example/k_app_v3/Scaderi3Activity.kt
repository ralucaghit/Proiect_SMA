...
class Scaderi3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_scaderi3)

        // Legaturi cu elementele din layout
        val tvOperation: TextView = findViewById(R.id.sub3Text)
        val etAnswer: EditText = findViewById(R.id.ans3Sub)
        val btnCheck: Button = findViewById(R.id.verif3BtnSub)
        val tvResult: TextView = findViewById(R.id.rez3Sub)
        val tvScore: TextView = findViewById(R.id.scor3Sub)
