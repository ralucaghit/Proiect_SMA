...
class Adunari2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_adunari2)

        // Legaturi cu elementele din layout
        val tvOperation: TextView = findViewById(R.id.add2Text)
        val etAnswer: EditText = findViewById(R.id.ans2Add)
        val btnCheck: Button = findViewById(R.id.verif2BtnAdd)
        val tvResult: TextView = findViewById(R.id.rez2Add)
        val tvScore: TextView = findViewById(R.id.scor2Add)
