...
class Scaderi1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_scaderi1)

        // Legaturi cu elementele din layout
        val tvOperation: TextView = findViewById(R.id.sub1Text)
        val etAnswer: EditText = findViewById(R.id.ans1Sub)
        val btnCheck: Button = findViewById(R.id.verif1BtnSub)
        val tvResult: TextView = findViewById(R.id.rez1Sub)
        val tvScore: TextView = findViewById(R.id.scor1Sub)
